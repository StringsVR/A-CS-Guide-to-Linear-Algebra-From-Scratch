...
\section{Basic Concepts}
    ...
    \subsection{Vectors}
        ...
        \subsubsection{Geometric}
            \begin{figure}[h]
                \centering
                \includegraphics[width=1\textwidth]{https://stringsvr.github.io/CS-Guide-to-LA-Build/examples/1-1.png} 
            ...
            \begin{figure}[H]
                \centering
                \includegraphics[width=1\textwidth]{https://stringsvr.github.io/CS-Guide-to-LA-Build/examples/1-2.png} 
